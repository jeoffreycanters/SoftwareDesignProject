...
public abstract class TicketFactory {
    ...
    public Tickets createTicket(String ticketType, UUID Payer, ArrayList<UUID> users){
        Tickets tickets = createTicket(ticketType, Payer);
        tickets.setIndebted(users);
        return tickets;
    }

    public Tickets createTickets(String ticketType, User Payer) {
        return createTicket(ticketType, Payer.getID());
    }
